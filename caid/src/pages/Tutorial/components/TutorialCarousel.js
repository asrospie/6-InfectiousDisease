import { Button, Container, Row, Modal, ModalBody } from 'react-bootstrap';
...
const Tutorial = ({onHide, show}) => {
    return (
        <Modal  onHide={() => onHide()} show={show}  aria-labelledby="contained" dialogClassName="large-modal">
